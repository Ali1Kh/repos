        ...
        <>
            <div className='main'>
                <div className='container mt-5'>
                    ...
                    <p className='d-flex flex-column align-items-center justify-content-center pb-3'>Enter your details to receive a reset link</p>
                    <form onSubmit={postEmail}>
                        <div className='row table table-squ d-flex align-items-center justify-content-center m-auto'>
                            ...
                            <button type="submit" className='btn-forgot'>Send</button>
